...
const localizedStrings = {
  ...
  en: {
    ...
    servers: 'Tomcat, WAMP',
    otherTools: 'JIRA, HP Quality Center, Suite Office',
    sinceJuly2016: 'Dev Tester - Test execution on online and coop features on the Ghost Recon Wildands project.',
    '2015-2016': 'Software tester - Quality assurance, testing strategies, testing plans design. Test execution on desktop and mobile. Management and issues solving. 3 weeks training in India and in english.',
    since2014: 'Auto-entrepreneur - WebTV animator, gaming content creation, cast of esport and others events, competitions shoutcast. Social networks, planning, team and community managment.',
